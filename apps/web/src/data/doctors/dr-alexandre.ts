...
export const drAlexandre: DoctorCard = {
  ...
  iconActions: [
    ...
    { id: 'map', label: 'Mapa', icon: 'map-pin', href: 'https://maps.app.goo.gl/4Zy8y4KTmWYt5m' },
  ...
  links: [
    ...
    { id: 'address', label: 'Consultório', sublabel: 'R. Pedro de Toledo, 108 · 15º andar · Vila Clementino', icon: 'building', href: 'https://maps.app.goo.gl/4Zy8y4KTmWYt5m' },
  ],
}