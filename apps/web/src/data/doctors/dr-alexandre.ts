...
export const drAlexandre: DoctorCard = {
  ...
  iconActions: [
    ...
    { id: 'map', label: 'Mapa', icon: 'map-pin', href: 'https://www.google.com/maps/place/Dr.+Alexandre+Frascino+-+Bucomaxilofacial/@-23.5982221,-46.6403818,17z' },
  ...
  links: [
    ...
    { id: 'address', label: 'Consultório', sublabel: 'R. Pedro de Toledo, 108 · 15º andar · Vila Clementino', icon: 'building', href: 'https://www.google.com/maps/place/Dr.+Alexandre+Frascino+-+Bucomaxilofacial/@-23.5982221,-46.6403818,17z' },
  ],
}
